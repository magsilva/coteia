...
<BODY text=#000000 vLink=#0000cc aLink=#ffff00 link=#cc0000 bgColor=#ffffff>
	<IMG alt="View this Page" src="<?echo $PATH_IMG?>/viewbw.gif" border=0>
	<IMG alt="Edit this Page" src="<?echo $PATH_IMG?>/editbw.gif" border=0>
	<A href="history.php?ident=<?echo $ident?>">
	<IMG alt="History of this Page" src="<?echo $PATH_IMG?>/history.gif" border=0></A>
	<A href="mostra.php?ident=<?echo $id_swiki?>">
	<IMG alt="Top of the Swiki" src="<?echo $PATH_IMG?>/indice.gif" border=0></A>
	<A href="JavaScript:AbreMapa(<?echo $id_swiki?>)">
	<img alt="Mapa do Site" src="<?echo $PATH_IMG?>/map.gif" border="0"/></A>
	<A href="changes.php?ident=<?echo $ident?>">
	<IMG alt="Recent Changes" src="<?echo $PATH_IMG?>/changes.gif" border=0></A>
	<A href="upload.php?ident=<?echo $ident?>">
	<IMG alt="File Attachments" src="<?echo $PATH_IMG?>/upload.gif" border=0></A>
	<A href="search.php?ident=<?echo $ident?>">
	<IMG alt="Search the Swiki" src="<?echo $PATH_IMG?>/search.gif" border=0></A>
	<A href="help.php">
	<IMG alt="Help Guide" src="<?echo $PATH_IMG?>/help.gif" border=0></A>
	<A href="JavaScript:AbreChat(<?echo $id_swiki?>)">
	<img alt="ChatServer" src="<?echo $PATH_IMG?>/chat.gif" border="0"/></A>
	<img alt="GroupNote" src="<?echo $PATH_IMG?>/notebw.gif" border="0"/>
	<A href="JavaScript:Imprime()">
	<img alt="Print this Page" src="<?echo $PATH_IMG?>/print.gif" border="0"/></A>
<br><br>
<?
/*
* Search.php

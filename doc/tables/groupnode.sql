...
insert into db (host,db,user,select_priv,insert_priv,update_priv,delete_priv,alter_priv) values ('localhost','coteia_groupnode','root','Y','Y','Y','Y','Y');
FLUSH PRIVILEGES;

CREATE DATABASE coteia_groupnode;

...
MakeDocs('separate HTML', "jade -t sgml -i html -d $LDP_HOME/ldp.dsl\#html " .
	 "$JADE_PUB/xml.dcl ../xml/CoTeia-Guide.xml");
MakeDocs('big HTML', "jade -V nochunks -t sgml -i html -d " .
         "$LDP_HOME/ldp.dsl\#html $JADE_PUB/xml.dcl " .
	 "../xml/CoTeia-Guide.xml > CoTeia-Guide.html");
MakeDocs('big text', "lynx -dump -nolist CoTeia-Guide.html " .
	 "> ../txt/CoTeia-Guide.txt");
MakeDocs('PDF', "jade -t tex -d $LDP_HOME/ldp.dsl\#print $JADE_PUB/xml.dcl " .
         '../xml/CoTeia-Guide.xml');
chdir '../pdf';
MakeDocs(undef, 'mv ../xml/CoTeia-Guide.tex .');
MakeDocs(undef, 'pdfjadetex CoTeia-Guide.tex');
MakeDocs(undef, 'pdfjadetex CoTeia-Guide.tex');
MakeDocs(undef, 'pdfjadetex CoTeia-Guide.tex');
MakeDocs(undef, 'rm CoTeia-Guide.tex CoTeia-Guide.log CoTeia-Guide.aux CoTeia-Guide.out');

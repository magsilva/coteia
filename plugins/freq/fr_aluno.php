...
{ 
	...
	{
         if ($listfreq[$i] == 'yes')
         echo "<td bgcolor=#FFFFFF><p align=center><img src=$URL_IMG/useron.png alt=presente></td>\n";
	 else if ($listfreq[$i] == 'no')
         echo "<td bgcolor=#FFFFFF><p align=center><img src=$URL_IMG/useroff.png alt=ausente></td>\n";
         else
